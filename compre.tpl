        ...
        <ul class="navbar-nav" id="font_menu_24">
            ...
            <li class="nav-item dropdown active">
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdown turquoise">
                    <a class="dropdown-item active" href="#">Comprehensive Care</a>
...
<section class="jumbotron text-center">
    <div class="container">
        <h1 class="jumbotron-heading service_text_align">Comprehensive Care</h1>
        <br/>
        <h3 class="lead text-muted service_text_side_title">Comprehensive Examination</h3>
        <h5 class="lead text-muted service_text_align">
        All new patients at Bay Star Dental would receive a comprehensive dental examination and a thorough cleaning. Some of the things we screen for during your visit with us would include:
            <ul>
                <li>Oral cancer</li>
        ...
        <h3 class="lead text-muted service_text_side_title ">Cleaning</h3>
        <h5 class="lead text-muted service_text_align">
        We focus our dental cleaning sessions to minimize chances of dental health problems and are designed to help you develop a beautiful and clean smile that lasts for life. As we note symptoms of periodontitis (gum disease), we offer comprehensive periodontal therapy services to halt and prevent additional infection at Bay Star Dental.
        </h5>
        <br/>
    </div>
</section>
