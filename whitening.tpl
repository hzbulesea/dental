...
<body>
   ...
   <section class="jumbotron text-center">
      <div class="container">
         ...
         <br/>
         <h3 class="lead text-muted service_text_side_title">In-Office Zoom Teeth Whitening </h3>
         <h5 class="lead text-muted service_text_align">
            Bay Star Dental offers patients an effective teeth whitening system with the help of Zoom technology. Modern laser has expanded its services in the field of dentistry as the number one whitening system. Zoom is a laser, teeth whitening technology that improves and brightens the shade of your teeth inside-out with peroxide gel. Its technology is ideal for anyone who is looking for immediate results
         </h5>
         <br/>
         <h5 class="lead text-muted service_text_align">
