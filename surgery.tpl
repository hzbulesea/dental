...
<body>
         ...
         <ul class="navbar-nav" id="font_menu_24">
            ...
            <li class="nav-item dropdown active">
               ...
               <div class="dropdown-menu" aria-labelledby="navbarDropdown turquoise">
                  ...
                  <a class="dropdown-item active" href="#">Oral Surgery</a>
   ...
   <section class="jumbotron text-center">
      <div class="container">
         <h1 class="jumbotron-heading service_text_align">Oral Surgery</h1>
         <br/>
         <h3 class="lead text-muted service_text_side_title">Extractions</h3>
         <h5 class="lead text-muted service_text_align">
            Tooth extractions are routine dental procedures used to remove decayed, damaged or otherwise problematic teeth. We usually make every effort to preserve natural teeth, although sometimes an extraction is necessary. Although the procedure is performed in a dentist’s office, it is considered surgery.
         </h5>
         <br/><br/>
